...
CONF_NOON_BRIGHTNESS, DEFAULT_NOON_BRIGHTNESS = "noon_brightness", 100
CONF_SUNRISE_BRIGHTNESS, DEFAULT_SUNRISE_BRIGHTNESS = "sunrise_brightness", 100
CONF_SUNSET_BRIGHTNESS, DEFAULT_SUNSET_BRIGHTNESS = "sunset_brightness", 100
CONF_MIDNIGHT_BRIGHTNESS, DEFAULT_MIDNIGHT_BRIGHTNESS = "midnight_brightness", 100
...
VALIDATION_TUPLES = [
    ...
    (CONF_SUNRISE_BRIGHTNESS, DEFAULT_SUNRISE_BRIGHTNESS, int_between(1, 100)),
    (CONF_SUNSET_BRIGHTNESS, DEFAULT_SUNSET_BRIGHTNESS, int_between(1, 100)),
    (CONF_NOON_BRIGHTNESS, DEFAULT_NOON_BRIGHTNESS, int_between(1, 100)),
    (CONF_MIDNIGHT_BRIGHTNESS, DEFAULT_MIDNIGHT_BRIGHTNESS, int_between(1, 100)),
